package pb2.screen.tutorial 
{
	 ...
	 * @author jaycsantos
	 */
	public class PopInfoNewScore extends PopWindow 
	{
		
		public function PopInfoNewScore( title:String, text:String ) 
		{
			super();
			...
			{//-- contents
				var txf:TextField;
				_contents.addChild( UIFactory.createFixedTextField(title, 'tutHead', 'left', 489, 223) );
				_contents.addChild( txf = UIFactory.createTextField(text, 'tutText', 'none', 487, 243) );
				txf.wordWrap = true; txf.width = 138; txf.height = 58;
			}
			
			{//-- pop ani
				_bg.addChild( _clip = PuttBase2.assets.createDisplayObject('screen.tutorial.popInfoNewScore') as MovieClip );
				_clip.gotoAndStop( 1 );
